...
public:
        ...
        void            get_analysis(int around, std::vector<csv::MedicationOrder>& orders) const;

        bool            has_recovered(float a1c) const;
        bool 		has_over_margin(float a1c) const;
        unsigned        total_recovery_length(float a1c) const;
private:
        int					pid;
